...
mixin _$UserEntity {
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, email, name, emailVerification);

  @override
  String toString() {
    return 'UserEntity(id: $id, email: $email, name: $name, emailVerification: $emailVerification)';
  }
}
...
abstract mixin class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, String name, bool emailVerification});
}
...
extension UserEntityPatterns on UserEntity {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(
            String id, String email, String name, bool emailVerification)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UserEntity() when $default != null:
        return $default(
            _that.id, _that.email, _that.name, _that.emailVerification);
      case _:
        return orElse();
    }
  }
